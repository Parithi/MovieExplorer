...
public class MovieProvider extends ContentProvider {
    ...
    private Cursor getMovieById(Uri uri, String[] projection, String sortOrder) {
        String id = MovieContract.MovieEntry.getIdFromMovieUri(uri);
                ...
                try {
                    for (ContentValues value : values) {
                        ...
                        if (_id != -1) {
                            ...
                            db.update(MovieContract.MovieEntry.TABLE_NAME,value,MovieContract.MovieEntry._ID + " = ?" , new String[]{_id+""});
                            returnCount++;
                        }
                    }
